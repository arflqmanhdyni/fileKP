...
$(document).ready(function(){
    $('#provinsi').change(function(){
        ...
        //Mengambil value pada option select provinsi kemudian parameternya dikirimkan menggunakan ajax 
        var prov = $('#provinsi').val();

          $.ajax({
            type : 'GET',
               url : 'pilih_kabupaten.php',
            data :  'prov_id=' + prov,
                success: function (data) {

                //jika data berhasil diambil, kemudian akan ditampilkan ke dalam option select kabupaten
                $("#kabupaten").html(data);
            }
          });
    });
    ...
    $("#cek").click(function(){
        //Mengambil suatu value dari option select provinsi asal, kabupaten, kurir, berat kemudian parameternya dikirim menggunakan ajax 
        var asal = $('#asal').val();
