        ...
        <div class="banner">
            <div class="jumbotron jumbotron-bg text-center rounded-0" style="background-image: url('assets/img/baner4.jpg');">
                <div class="container">
                    ...
                    <p class="lead">
                       Menyediakan berbagai pilihan produk : Laptop, PC, Laptop, Aksesoris, Laptop, Sparepart.
                    </p>
  ...
  <!-- option urutan -->
    ...
    <?php
          ...
          if(isset($_GET['sequence']) && $_GET['sequence'] == "price"){
              if(isset($_GET['cari'])){
                  $search = $_GET['cari'];
                  $data = mysqli_query($config,"SELECT * FROM product INNER JOIN kategori ON product.product_kategori=kategori.kategori_id WHERE kategori_nama='Laptop' and product_nama like '%$search%' order by product_harga asc LIMIT $start, $hal");
              }else{
                  $data = mysqli_query($config,"SELECT * FROM product WHERE product_kategori=2101 order by product_harga asc LIMIT $start, $hal");
              }
          }elseif(isset($_GET['sequence']) && $_GET['sequence'] == "price1"){
              if(isset($_GET['cari'])){
                  $search = $_GET['cari'];
                  $data = mysqli_query($config,"SELECT * FROM product INNER JOIN kategori ON product.product_kategori=kategori.kategori_id WHERE kategori_nama='Laptop' and product_nama like '%$search%' order by product_harga desc LIMIT $start, $hal");
              }else{
                  $data = mysqli_query($config,"SELECT * FROM product WHERE product_kategori=2101 order by product_harga desc LIMIT $start, $hal");
              }
              ...
              if(isset($_GET['cari'])){
                  $search = $_GET['cari'];
                  $data = mysqli_query($config,"SELECT * FROM product INNER JOIN kategori ON product.product_kategori=kategori.kategori_id WHERE kategori_nama='Laptop' and product_nama like '%$search%' order by product_nama asc LIMIT $start, $hal");
              }else{
                  $data = mysqli_query($config,"SELECT * FROM product WHERE product_kategori=2101 order by product_id desc LIMIT $start, $hal");
              }
   ...
   <!-- start card product -->
    <div class="col-md-4 ">
        ...
        <div class="wsk-cp-text">
          <div class="category">
            ...
            <?php
            $kat = mysqli_query($config, "SELECT * FROM kategori WHERE kategori_nama='Laptop'");
    ...
    <!-- end card product -->
      ...
      <nav aria-label="Page navigation">
        ...
        <li class="page-item"><a class="page-link" href="kategori_laptop.php">Back</a></li>
